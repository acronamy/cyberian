...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["$"] = __webpack_require__(121);
...
var cls = __webpack_require__(14);
var defaultSettings = __webpack_require__(127);
var dom = __webpack_require__(8);
var EventManager = __webpack_require__(124);
...
var getNative = __webpack_require__(24),
    ...
    shimKeys = __webpack_require__(77);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return isSVGAvatar; });
...
function attemptVertx() {
  try {
    var r = require;
    var vertx = __webpack_require__(143);
...
const avatarTemplate = (avatar)=>{
    if(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["c" /* isSVGAvatar */])(avatar)){
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dragula__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_jshashes__ = __webpack_require__(122);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_perfect_scrollbar__ = __webpack_require__(123);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__editor_sidebar__ = __webpack_require__(54);
...
__WEBPACK_IMPORTED_MODULE_0_jquery__(function () {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__(".rail").each(function () {
        __WEBPACK_IMPORTED_MODULE_4_perfect_scrollbar__["initialize"](__WEBPACK_IMPORTED_MODULE_0_jquery__(this)[0])
    })

    __WEBPACK_IMPORTED_MODULE_0_jquery__(".editor-collection-photo").each(function () {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(this).orientation()
    })
    ...
    //Save button
    __WEBPACK_IMPORTED_MODULE_0_jquery__("#collection-save").click(function () {
    ...
    if (location.pathname.split("/")[1] === "editor" && __WEBPACK_IMPORTED_MODULE_0_jquery__(".gridstack").length >= 0) {
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__editor_sidebar__["a" /* sidebar */])()
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__(".photo-upload-target").on("change", function (e) {
            ...
            var upload = new __WEBPACK_IMPORTED_MODULE_2__utils__["b" /* Upload */]("/save/collection/photo", file);
            // execute upload
            ...
            upload.doUpload(function (uploaded) {
                ...
                if (uploaded.success) {
                    ...
                    validate(__WEBPACK_IMPORTED_MODULE_0_jquery__(".add-placeholder").siblings().length > 0 || false)
        ...
        function checkValidation(target) {
            function checkRequirements() {
                ...
                //criteria
                var validationName = target.hasClass("collection-name") && target.val() !== "" && __WEBPACK_IMPORTED_MODULE_0_jquery__(".collection-description").val() !== "";
                var validationDescription = target.hasClass("collection-description") && target.val() !== "" && __WEBPACK_IMPORTED_MODULE_0_jquery__(".collection-name").val() !== "";
                ...
                if (validationForm) {
                    __WEBPACK_IMPORTED_MODULE_0_jquery__("#collection-save").removeAttr("disabled")
                }
                else {
                    __WEBPACK_IMPORTED_MODULE_0_jquery__("#collection-save").attr("disabled", "disabled")
                }
            }
            checkRequirements()
        ...
        function validate(hasPhoto) {
            if (hasPhoto) {
                __WEBPACK_IMPORTED_MODULE_0_jquery__(".collection-group").find("[required]").each(function () {
                    checkValidation(__WEBPACK_IMPORTED_MODULE_0_jquery__(this))
                })
            }
            else {
                __WEBPACK_IMPORTED_MODULE_0_jquery__("#collection-save").attr("disabled", "disabled")
...
window.addEventListener("load",function(){
    setTimeout(function(){
        __WEBPACK_IMPORTED_MODULE_0_jquery__("#profile-sub-navbar").stick({
        to:__WEBPACK_IMPORTED_MODULE_0_jquery__("#admin-toolbar")
    });
    },1)
})
...
__WEBPACK_IMPORTED_MODULE_0_jquery__(function(){
    var userInstance = JSON.parse(localStorage.getItem("user"));
    if(__WEBPACK_IMPORTED_MODULE_0_jquery__("body.page-login.logged-in").length>0){
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__utils__["a" /* active */])(__WEBPACK_IMPORTED_MODULE_0_jquery__("#admin-toolbar"),".navbar-user > .dropdown");
        __WEBPACK_IMPORTED_MODULE_0_jquery__(".username").append("<span class='profile-first-name'>"+userInstance.first_name+"</span> "+"<span class='profile-last-name'>"+userInstance.last_name+"</span>" )
        __WEBPACK_IMPORTED_MODULE_0_jquery__(".bio").append(userInstance.bio)
    }

    __WEBPACK_IMPORTED_MODULE_0_jquery__("#cover-photo").on("change",function(e){
        var file = __WEBPACK_IMPORTED_MODULE_0_jquery__(this)[0].files[0];
        var upload = new __WEBPACK_IMPORTED_MODULE_1__utils__["b" /* Upload */]("/upload/cover-photo" ,file);
        // execute upload
        upload.doUpload();
    })
})
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_mousetrap__ = __webpack_require__(30);
...
__WEBPACK_IMPORTED_MODULE_0_jquery__(function () {
    if (__WEBPACK_IMPORTED_MODULE_0_jquery__("body").hasClass("page-login") && __WEBPACK_IMPORTED_MODULE_0_jquery__("body").find(".wrapper-login").length > 0) {

        __WEBPACK_IMPORTED_MODULE_1_mousetrap__["bind"]("enter", function () {
            ...
            */
            if (__WEBPACK_IMPORTED_MODULE_0_jquery__("#username").val() !== "") {
                ...
                __WEBPACK_IMPORTED_MODULE_0_jquery__("#username").parent().addClass("error");
            }
        ...
        */
        ...
        //no local storage on my username
            ...
            __WEBPACK_IMPORTED_MODULE_0_jquery__("#username").focus();
        }
    ...
    else if(__WEBPACK_IMPORTED_MODULE_0_jquery__("body").hasClass("page-login") && __WEBPACK_IMPORTED_MODULE_0_jquery__("body").find(".wrapper-register").length > 0){
       
       /**
        * Toggle hire status
       */
       __WEBPACK_IMPORTED_MODULE_0_jquery__("[data-toggle]").on("mouseup",function(){
            var state = !__WEBPACK_IMPORTED_MODULE_0_jquery__(this).find("input[type='checkbox']").is(":checked");
            
            if(state===false){
                __WEBPACK_IMPORTED_MODULE_0_jquery__(".hire-status").find(".hire-status-false").removeClass("hide")
                __WEBPACK_IMPORTED_MODULE_0_jquery__(".hire-status").find(".hire-status-true").addClass("hide")
            }
            else{
                __WEBPACK_IMPORTED_MODULE_0_jquery__(".hire-status").find(".hire-status-false").addClass("hide")
                __WEBPACK_IMPORTED_MODULE_0_jquery__(".hire-status").find(".hire-status-true").removeClass("hide")
            }
       })

       __WEBPACK_IMPORTED_MODULE_0_jquery__("#submit").click(function(){
            __WEBPACK_IMPORTED_MODULE_0_jquery__["post"]("/user/register/new", {
                first_name:__WEBPACK_IMPORTED_MODULE_0_jquery__("#first_name").val(),
                last_name:__WEBPACK_IMPORTED_MODULE_0_jquery__("#last_name").val(),
                bio:__WEBPACK_IMPORTED_MODULE_0_jquery__("#bio").val(),
                for_hire:__WEBPACK_IMPORTED_MODULE_0_jquery__("#for-hire").is(":checked"),
                email:__WEBPACK_IMPORTED_MODULE_0_jquery__("#email").val(),
                username:__WEBPACK_IMPORTED_MODULE_0_jquery__("#username").val(),
                password:__WEBPACK_IMPORTED_MODULE_0_jquery__("#password").val()
            }, function(pass){
                if(pass){
...
__WEBPACK_IMPORTED_MODULE_0_jquery__["fn"].stick = function(options){
    if(__WEBPACK_IMPORTED_MODULE_0_jquery__(this).length>0){

        var tt = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).offset().top;
        var target = __WEBPACK_IMPORTED_MODULE_0_jquery__(this);
        var defaults = {
            to:0,
            cssCached:{
                width:"100%",
                top:__WEBPACK_IMPORTED_MODULE_0_jquery__(this).css("top"),
                position:__WEBPACK_IMPORTED_MODULE_0_jquery__(this).css("position"),
                "z-index":__WEBPACK_IMPORTED_MODULE_0_jquery__(this).css("z-index"),
                height:__WEBPACK_IMPORTED_MODULE_0_jquery__(this).outerHeight(),
        ...
        if(typeof options.to === "object"){
            options.to = __WEBPACK_IMPORTED_MODULE_0_jquery__(options.to).outerHeight()
        }

        __WEBPACK_IMPORTED_MODULE_0_jquery__(window).on("scroll", function(e){
            var st = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).scrollTop() + options.to;
            if(st>=tt){
                target.css({
                    position:"fixed",
                    top:options.to+"px",
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./admin-toolbar.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./admin-toolbar.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./dragula.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./dragula.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./site-theme.scss", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/sass-loader/lib/loader.js!./site-theme.scss");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_bootstrap_dist_js_bootstrap__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__scripts_sticky__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__scripts_portrait_landscape__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__scripts_editor__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__scripts_admin_toolbar__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__scripts_remember_login__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__scripts_profile__ = __webpack_require__(35);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_bootstrap_tagsinput_dist_bootstrap_tagsinput_css__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_bootstrap_tagsinput_dist_bootstrap_tagsinput_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_bootstrap_tagsinput_dist_bootstrap_tagsinput_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_perfect_scrollbar_dist_css_perfect_scrollbar_min_css__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_perfect_scrollbar_dist_css_perfect_scrollbar_min_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_perfect_scrollbar_dist_css_perfect_scrollbar_min_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__styles_index_scss__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__styles_index_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_10__styles_index_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__styles_loader_scss__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__styles_loader_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11__styles_loader_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__styles_site_theme_scss__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__styles_site_theme_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12__styles_site_theme_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__styles_folder_scss__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__styles_folder_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13__styles_folder_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__styles_dragula_scss__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__styles_dragula_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_14__styles_dragula_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__styles_login_scss__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__styles_login_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_15__styles_login_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__styles_toggle_scss__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__styles_toggle_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_16__styles_toggle_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__styles_admin_toolbar_scss__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__styles_admin_toolbar_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_17__styles_admin_toolbar_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__styles_profile_scss__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__styles_profile_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_18__styles_profile_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__styles_editor_scss__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__styles_editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_19__styles_editor_scss__);
...
var Dropbox = __webpack_require__(113)
var BootstrapMenu = __webpack_require__(87);
...
var spinner = {
    show(target){
        __WEBPACK_IMPORTED_MODULE_0_jquery__(target).addClass("loading")
        __WEBPACK_IMPORTED_MODULE_0_jquery__(target).find(".spinner").removeClass("hide")
    },
    hide(target){
        __WEBPACK_IMPORTED_MODULE_0_jquery__(target).removeClass("loading")
        __WEBPACK_IMPORTED_MODULE_0_jquery__(target).find(".spinner").addClass("hide")
    }
}

function showFolderSpinner(){
    __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass("loading")
    __WEBPACK_IMPORTED_MODULE_0_jquery__(this).find(".spinner").removeClass("hide")
}
...
function sidebar() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__(".folder-row.dropbox").click(async function(){

        if(__WEBPACK_IMPORTED_MODULE_0_jquery__(this).hasClass("pending")){
            var self = __WEBPACK_IMPORTED_MODULE_0_jquery__(this);
            var path = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).data("path");
            ...
            for(var file of filesRes){
                ...
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).next("ul").append(`<li data-id="${file.id}" class="list-group-item"> <div class="hide loader"></div> <div class="photo-thumbnail"></div> ${file.name} <span class="status pull-right"><span class="glyphicon glyphicon-download-alt download"></span> <span class="spinner"></span> <span class="glyphicon glyphicon-ok"></span></span> </li>`)

                if(localStorage.getItem(file.id)){
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(`[data-id="${file.id}"]`).addClass("valid")
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(`[data-id="${file.id}"]`).find(".photo-thumbnail").css({backgroundImage:`url('${localStorage.getItem(file.id)}')`})
                }
                else{
                    if(ext === "jpg" || ext === "jpeg" || ext === "png"){
                        ...
                        reader.onloadend = function() {
                            ...
                            __WEBPACK_IMPORTED_MODULE_0_jquery__(`[data-id="${file.id}"]`).addClass("valid")
                            __WEBPACK_IMPORTED_MODULE_0_jquery__(`[data-id="${file.id}"]`).find(".photo-thumbnail").css({backgroundImage:`url('${base64data}')`})
                        }
                    }
                }
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on("click",".list-group-item .download",async function(){
        var listItem = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).parent();
    ...
    function singleSelect(){
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).off("mousedown");
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on("mousedown",".collection-photo-list .list-group-item",function(e){
            if(e.which === 1){//primary click
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass("selected")
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).siblings().removeClass("selected");
            }
        })
    }
    ...
    //select of any
    __WEBPACK_IMPORTED_MODULE_1_mousetrap__["bind"]('ctrl', (e)=> {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).off("mousedown");
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on("mousedown",".collection-photo-list .list-group-item",function(){
            if(__WEBPACK_IMPORTED_MODULE_0_jquery__(this).hasClass("selected")){
    ...
    __WEBPACK_IMPORTED_MODULE_1_mousetrap__["bind"]('shift', (e)=> {
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).off("mousedown");
        __WEBPACK_IMPORTED_MODULE_0_jquery__(document).on("mousedown",".collection-photo-list .list-group-item",function(){
            __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass("selected")
            var selectIndex = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).index()
            var firstSelect = __WEBPACK_IMPORTED_MODULE_0_jquery__(".selected").index()
            var direction = selectIndex  === firstSelect?"up":"down";

            if(direction === "down"){
                __WEBPACK_IMPORTED_MODULE_0_jquery__(".collection-photo-list .list-group-item").each(function(index){
                if(index <= selectIndex && index >= firstSelect){
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(this).addClass("selected");
                }
            })
            }
            else if(direction === "up" && __WEBPACK_IMPORTED_MODULE_0_jquery__(".list-group-item.selected").length > 1){
                __WEBPACK_IMPORTED_MODULE_0_jquery__(this).nextUntil(".list-group-item.selected").addClass("selected")
            }
        ...
        actions: {
            copy: {
                ...
                onClick(el) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(".list-group-item.selected").each(function(index){
                        clipboard[index] = {
                            id: __WEBPACK_IMPORTED_MODULE_0_jquery__(this).data("id"),
                            html: __WEBPACK_IMPORTED_MODULE_0_jquery__(this)[0].outerHTML
                        };
                    })
            ...
            paste: {
                ...
                onClick(el) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(el).parent().find(".selected").remove();
                    
                    pasteContent.forEach(function(item){
                        __WEBPACK_IMPORTED_MODULE_0_jquery__(el).parent().append(item);
                    })
                    clipboard = [];
                }
            },
            delete: {
                name: "Delete",
                onClick(el) {
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(".list-group-item.selected").remove();
                }
            }
        }
    });
    ...
    const folderMenu = new BootstrapMenu('.folder-row', {
        ...
        actions: {
            paste: {
                name: "Paste",
                isEnabled(el) {
                    if (clipboard.length > 0 && !__WEBPACK_IMPORTED_MODULE_0_jquery__(el).hasClass("dropbox")) {
                        return true;
                    }
                    else {
                        return false;
                ...
                onClick(el) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_jquery__(el).next().find(".selected").remove();
                    
                    pasteContent.forEach(function(item){
                        __WEBPACK_IMPORTED_MODULE_0_jquery__(el).next().append(item);
                    })
                    clipboard = [];
                }
            },
            delete: {
                ...
                isEnabled(el) {
                    if (!__WEBPACK_IMPORTED_MODULE_0_jquery__(el).hasClass("dropbox")) {
                        return true;
                    }
                    else {
                        return false;
...
_.noop = __webpack_require__(85);
_.each = __webpack_require__(57);
_.contains = __webpack_require__(56);
_.extend = __webpack_require__(81);
_.uniqueId = __webpack_require__(86);
_.isFunction = __webpack_require__(28);
...
var ticky = __webpack_require__(142);
...
var atoa = __webpack_require__(55);
...
var customEvent = __webpack_require__(107);
var eventmap = __webpack_require__(94);
var doc = global.document;
...
// module
exports.push([module.i, "body.page-login.logged-in {\n  background-image: none; }\n  body.page-login.logged-in #user-hero {\n    background-size: cover;\n    background-position: center;\n    height: 300px;\n    position: relative;\n    display: table;\n    width: 100%;\n    padding-right: 30px;\n    padding-left: 30px;\n    padding-top: 20px;\n    padding-bottom: 20px; }\n    body.page-login.logged-in #user-hero:before {\n      content: \"\";\n      background-image: url(\"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHklEQVQYV2NkwAIY8Qr+///fl5GRcTNIEX6VyMYAANDMBAYBjpzVAAAAAElFTkSuQmCC\");\n      display: block;\n      top: 0;\n      bottom: 0;\n      left: 0;\n      right: 0;\n      position: absolute;\n      background-color: rgba(0, 0, 0, 0.3);\n      z-index: 1; }\n    body.page-login.logged-in #user-hero > * {\n      z-index: 2;\n      position: relative; }\n    body.page-login.logged-in #user-hero .username {\n      color: #f1f1f1;\n      text-transform: capitalize;\n      font-weight: 100;\n      width: 100%;\n      text-align: center;\n      display: table-cell;\n      vertical-align: middle; }\n      body.page-login.logged-in #user-hero .username:empty:before {\n        content: \"username\"; }\n    body.page-login.logged-in #user-hero [for=\"cover-photo\"] {\n      position: relative;\n      border-radius: 1px;\n      color: #f1f1f1;\n      background-color: rgba(255, 255, 255, 0);\n      border: 1px solid #f1f1f1;\n      display: inline-block; }\n      body.page-login.logged-in #user-hero [for=\"cover-photo\"]:before {\n        content: \"Cover Photo\";\n        float: right;\n        white-space: nowrap;\n        padding-left: 10px; }\n      body.page-login.logged-in #user-hero [for=\"cover-photo\"] [type=\"file\"] {\n        height: 100%;\n        display: none; }\n  body.page-login.logged-in #profile-sub-navbar {\n    background-color: #171717;\n    border-radius: 0;\n    border: 0;\n    width: 100%;\n    border-bottom: 1px solid rgba(255, 255, 255, 0.1);\n    position: relative;\n    text-align: center; }\n    body.page-login.logged-in #profile-sub-navbar .btn-group-pill {\n      border-radius: 1px; }\n      body.page-login.logged-in #profile-sub-navbar .btn-group-pill .btn {\n        border: 1px solid rgba(255, 255, 255, 0.1);\n        color: #f1f1f1;\n        background-color: transparent;\n        border-radius: 0;\n        border-right-width: 0;\n        color: #9d9d9d;\n        border-left-width: 0;\n        margin-left: 0; }\n        body.page-login.logged-in #profile-sub-navbar .btn-group-pill .btn:focus {\n          color: #fff;\n          outline: 0; }\n        body.page-login.logged-in #profile-sub-navbar .btn-group-pill .btn:last-child {\n          border-top-right-radius: 2px;\n          border-bottom-right-radius: 2px;\n          border-right-width: 1px; }\n        body.page-login.logged-in #profile-sub-navbar .btn-group-pill .btn:first-child {\n          border-top-left-radius: 2px;\n          border-bottom-left-radius: 2px;\n          border-left-width: 1px; }\n    body.page-login.logged-in #profile-sub-navbar .navbar-header {\n      width: 100%; }\n  body.page-login.logged-in .wrapper-profile {\n    height: 100vh; }\n", ""]);
...
var getBaseURL = __webpack_require__(19);
var httpHeaderSafeJson = __webpack_require__(29);
...
var REQUEST_CONSTANTS = __webpack_require__(115);
var DropboxBase;
...
DropboxBase.prototype.getRpcRequest = function () {
  if (DropboxBase.prototype.rpcRequest === undefined) {
    DropboxBase.prototype.rpcRequest = __webpack_require__(117);
  }
...
DropboxBase.prototype.getDownloadRequest = function () {
  if (DropboxBase.prototype.downloadRequest === undefined) {
    DropboxBase.prototype.downloadRequest = __webpack_require__(110);
  }
...
DropboxBase.prototype.getUploadRequest = function () {
  if (DropboxBase.prototype.uploadRequest === undefined) {
    DropboxBase.prototype.uploadRequest = __webpack_require__(118);
  }
...
var DropboxBase = __webpack_require__(111);
...
var Dropbox = __webpack_require__(112);
...
( function( factory ) {
	if ( true ) {
		...
		!(__WEBPACK_AMD_DEFINE_ARRAY__ = [ __webpack_require__(0), __webpack_require__(120) ], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
...
var initialize = __webpack_require__(136);
...
// Handlers
var handlers = {
  'click-rail': __webpack_require__(129),
  'drag-scrollbar': __webpack_require__(130),
  'keyboard': __webpack_require__(131),
  'wheel': __webpack_require__(132),
  'touch': __webpack_require__(135),
  'selection': __webpack_require__(134)
};
var nativeScrollHandler = __webpack_require__(133);
